...
def balanced_network_stdp(args):
    ...
    neuron_model.modify_model('parameters',
                              ...
                              key='Vm')
    neuron_model.modify_model('parameters', args.ca_decays,
                              key='tau_ca')
    ...
    if not args.quiet:
        ...
        print(pd.DataFrame(np.array(stdp_synapse.w_plast/mV)).describe())
        print("Inhibitory synapses:")
        print(pd.DataFrame(np.array(inh_synapse.weight/mV)).describe())
        print("Excitatory synapses:")
        print(pd.DataFrame(np.array(exc_synapse.weight/mV)).describe())
