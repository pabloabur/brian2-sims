...
from utils.SLIF_utils import neuron_rate, permutation_from_rate
#from orca_column import orcaColumn
from parameters.monitor_params import monitor_params, selected_cells
...
from utils.testbench import SequenceTestbench
from utils.misc import neuron_group_from_spikes
...
from parameters.orca_params import syn_intra_prob, syn_intra_plast, neu_pop,\
...
column['ff_pyr'].namespace['eta'] = 0*mV
